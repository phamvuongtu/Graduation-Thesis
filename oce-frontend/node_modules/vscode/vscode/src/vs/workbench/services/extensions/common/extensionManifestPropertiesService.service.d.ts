...
declare const IExtensionManifestPropertiesService: ServiceIdentifier<IExtensionManifestPropertiesService>;
interface IExtensionManifestPropertiesService {
...
export { IExtensionManifestPropertiesService };
