...
interface IFileWorkingCopyModelConfiguration {
    /**
...
declare const enum SnapshotContext {
    Save = 1,
    Backup = 2
}
/**
...
export { type IFileWorkingCopy, type IFileWorkingCopyModel, type IFileWorkingCopyModelConfiguration, type IResolvedFileWorkingCopy, SnapshotContext };
