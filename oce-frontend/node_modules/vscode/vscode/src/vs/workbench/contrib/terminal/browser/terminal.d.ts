...
import { IShellLaunchConfig, ITerminalTabLayoutInfoById, TerminalLocation, ITerminalProfile, IExtensionTerminalProfile, TerminalIcon, IReconnectionProperties, WaitOnExitValue, ITerminalLaunchError, TerminalExitReason, TitleEventSource, TerminalShellType, ITerminalDimensions, IShellIntegration } from '../../../../platform/terminal/common/terminal.js';
