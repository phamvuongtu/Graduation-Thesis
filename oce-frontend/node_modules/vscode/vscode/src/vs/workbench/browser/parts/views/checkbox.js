...
const _moduleId = "vs/workbench/browser/parts/views/checkbox";
...
class TreeItemCheckbox extends Disposable {
    ...
    checkboxHoverContent(checkbox) {
        return checkbox.tooltip ? checkbox.tooltip :
            checkbox.isChecked ? ( localizeWithPath(_moduleId, 0, 'Checked')) : ( localizeWithPath(_moduleId, 1, 'Unchecked'));
    }
