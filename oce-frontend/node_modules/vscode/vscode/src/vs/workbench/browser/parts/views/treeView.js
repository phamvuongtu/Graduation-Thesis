...
import { ITreeViewsService } from '../../../services/views/browser/treeViewsService.service.js';
...
var TreeRenderer_1;
const _moduleId = "vs/workbench/browser/parts/views/treeView";
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: ( localizeWithPath(_moduleId, 3, "Refresh")),
                    menu: {
                        id: MenuId.ViewTitle,
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: ( localizeWithPath(_moduleId, 4, "Collapse All")),
                    menu: {
                        id: MenuId.ViewTitle,
                        when: ( (ContextKeyExpr.and(
                             (ContextKeyExpr.equals('view', that.id)),
