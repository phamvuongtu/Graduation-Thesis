...
interface ScrollableElementCreationOptions {
    /**
...
export type { ScrollableElementChangeOptions, ScrollableElementCreationOptions, ScrollableElementResolvedOptions };
