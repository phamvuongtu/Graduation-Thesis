...
import { IWorkspaceTrustUriInfo, IWorkspaceTrustTransitionParticipant, WorkspaceTrustRequestOptions, WorkspaceTrustUriResponse } from './workspaceTrust.js';

declare const IWorkspaceTrustEnablementService: ServiceIdentifier<IWorkspaceTrustEnablementService>;
interface IWorkspaceTrustEnablementService {
    readonly _serviceBrand: undefined;
    isWorkspaceTrustEnabled(): boolean;
}
declare const IWorkspaceTrustManagementService: ServiceIdentifier<IWorkspaceTrustManagementService>;
interface IWorkspaceTrustManagementService {
    readonly _serviceBrand: undefined;
...
export { IWorkspaceTrustEnablementService, IWorkspaceTrustManagementService, IWorkspaceTrustRequestService };
