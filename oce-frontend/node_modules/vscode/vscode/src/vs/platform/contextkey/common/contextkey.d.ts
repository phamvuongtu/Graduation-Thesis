...
import { IContextKeyService } from './contextkey.service.js';
...
declare abstract class ContextKeyExpr {
...
declare class RawContextKey<T extends ContextKeyValue> extends ContextKeyDefinedExpr {
...
export { ContextKeyAndExpr, ContextKeyDefinedExpr, ContextKeyEqualsExpr, ContextKeyExpr, ContextKeyExprType, type ContextKeyExpression, ContextKeyFalseExpr, ContextKeyGreaterEqualsExpr, ContextKeyGreaterExpr, ContextKeyInExpr, type ContextKeyInfo, ContextKeyNotEqualsExpr, ContextKeyNotExpr, ContextKeyNotInExpr, ContextKeyNotRegexExpr, ContextKeyOrExpr, ContextKeyRegexExpr, ContextKeySmallerEqualsExpr, ContextKeySmallerExpr, ContextKeyTrueExpr, type ContextKeyValue, type IContext, type IContextKey, type IContextKeyChangeEvent, type IContextKeyExprMapper, type IContextKeyExpression, type IContextKeyServiceTarget, type IReadableSet, type IScopedContextKeyService, RawContextKey };
