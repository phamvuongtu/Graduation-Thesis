 ...
 * @internal
 */
interface IDiffEditorContribution {
    /**
     * Dispose this contribution.
     */
    dispose(): void;
...
export type { ICodeEditorViewState, IContentDecorationRenderOptions, ICursorState, IDecorationRenderOptions, IDiffEditor, IDiffEditorContribution, IDiffEditorModel, IDiffEditorViewModel, IDiffEditorViewState, IEditor, IEditorContribution, IThemeDecorationRenderOptions, IViewState };
